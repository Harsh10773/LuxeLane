...
import { FiSearch, FiShoppingCart, FiMenu, FiMapPin } from 'react-icons/fi';
...
const Navbar = () => {
    ...
    return (
        <header className="sticky top-0 z-50 flex flex-col">
            {/* Top Bar - Deep Royal Blue Gradient */}
            <nav className="bg-gradient-to-r from-[#1a1c32] to-[#262c50] text-white py-3 px-4 shadow-lg order-1">
                <div className="max-w-screen-2xl mx-auto flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/" className="flex flex-col leading-none hover:opacity-90 transition-opacity">
                            <span className="text-2xl font-black tracking-tighter bg-gradient-to-r from-blue-300 to-purple-400 bg-clip-text text-transparent">
                                LUXELANE
                            </span>
                    ...
                    <div className="flex items-center gap-5 sm:gap-6 min-w-fit">
                        ...
                        <Link to="/cart" className="relative flex items-center gap-1 hover:text-blue-300 transition">
                            <div className="relative">
                                ...
                                <span className="absolute -top-1 -right-2 bg-yellow-400 text-gray-900 text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center border-2 border-[#1a1c32]">
            ...
            <div className="bg-[#232f3e] text-white text-sm py-2 px-4 shadow-md overflow-x-auto whitespace-nowrap scrollbar-hide order-2">
                <div className="max-w-screen-2xl mx-auto flex space-x-6 items-center">
                    <button className="flex items-center gap-1 font-bold hover:text-blue-300"><FiMenu /> All</button>
                    {["Topics", "Today's Deals", "Electronics", "Fashion", "Home", "Mobiles", "Beauty"].map((item) => (
                        <button
                            ...
                            className="hover:text-blue-300 transition-colors bg-transparent border-none cursor-pointer"
                        >
                            {item}
                        </button>
                    ))}
